...
export default {
  ...
  /* ---------------------------------------------------------------- *
   * Host editor (New/Edit host)
   * ---------------------------------------------------------------- */
  "hosts.editor.titleNew": "New host",
  "hosts.editor.titleEdit": "Edit host",
  "hosts.editor.subtitle":
    "Where to connect, how to authenticate, and what to do once you are in.",
  "hosts.editor.thisHostIs": "This host is",
  "hosts.kind.ssh": "SSH",
  "hosts.kind.telnet": "Telnet",
  "hosts.kind.serial": "Serial",
  "hosts.kind.desktop": "Desktop",
  "hosts.kind.ipmi": "IPMI",
  "hosts.editor.telnetWarning":
    "Telnet is unencrypted. Everything sent over it, including whatever you type at a login prompt, is readable by anything on the path. Use it for devices that offer nothing better.",
  ...
  "hosts.editor.authMethod": "Authentication method",
  "hosts.editor.auth.password": "Password",
  "hosts.editor.auth.passwordHint": "Send a stored password",
  "hosts.editor.auth.keychain": "Keychain",
  "hosts.editor.auth.keychainHint": "Use a key from the app keychain",
  "hosts.editor.auth.key": "Key",
  "hosts.editor.auth.keyHint": "Paste a private key for this host only",
  "hosts.editor.auth.agent": "Agent",
  "hosts.editor.auth.agentHint": "Use keys held by your SSH agent",
  "hosts.editor.sshKey": "SSH key",
  "hosts.editor.noKeysInKeychain":
    "No SSH keys found. Add keys in the Keychain page first.",
  "hosts.editor.selectKey": "Select a key…",
  "hosts.editor.password": "Password",
  "hosts.editor.passwordPlaceholderStored": "Stored, leave blank to keep",
  "hosts.editor.passwordPlaceholder": "••••••••",
  "hosts.editor.showPassword": "Show password",
  "hosts.editor.hidePassword": "Hide password",
  "hosts.editor.storedPasswordHint": "A password is stored for this host.",
  "hosts.editor.privateKey": "Private key",
  "hosts.editor.privateKeyPlaceholderStored": "Stored, leave blank to keep",
  "hosts.editor.privateKeyPlaceholder": "-----BEGIN OPENSSH PRIVATE KEY-----…",
  "hosts.editor.storedPrivateKeyHint": "A private key is stored for this host.",
  "hosts.editor.keyPassphrase": "Key passphrase",
  "hosts.editor.keyPassphrasePlaceholder":
    "Leave empty if the key has no passphrase",
  "hosts.editor.chooseKeyFile": "Choose key file…",
  "hosts.editor.optional": "Optional",
  "hosts.editor.disclosure.nameAndTags": "Name and tags",
  "hosts.editor.displayName": "Display name",
  "hosts.editor.displayNameHint":
    "Left blank, this host is listed as the hostname / IP.",
  "hosts.editor.displayNamePlaceholder": "e.g. Production Server",
  ...
  "hosts.editor.disclosure.connectThrough": "Connect through",
  "hosts.editor.connectDirectly": "Connect directly",
  ...
  "hosts.editor.dialStraightOut": "Dial straight out",
  "hosts.editor.proxyJumpNote":
    "Reached through {jump}, the only connection out of this machine is the one to {jump}, so its own proxy setting is what opens it. The proxy chosen here is used when this host is dialled without the relay.",
  "hosts.editor.disclosure.runOnConnect": "Run on connect",
  ...
  "hosts.editor.disclosure.monitoring": "Monitoring",
  "hosts.editor.watchThisHost": "Watch this host",
  "hosts.editor.watchDesc":
    "While the app is open, check on a timer that something is still answering here. A host that stops raises a notification once, and its card is marked until it comes back.",
  "hosts.editor.checkPort": "Check port",
  "hosts.editor.checkPortHint":
    "Set it to watch something else on the same machine, a web server or a database, rather than the login this host is reached by.",
  ...
  "hosts.editor.checkPortHintDefaultOn":
    "Left blank, this host is checked on port {port}, the one it connects on.",
  "hosts.editor.monitorSummary": "Watched",
  "hosts.editor.monitorSummaryWithPort": "Watched on port {port}",
  "hosts.editor.advancedSummary": "Legacy algorithms allowed",
  "hosts.editor.desktopRdp": "RDP",
  "hosts.editor.desktopVnc": "VNC",
  "hosts.editor.bmcSameHost": "Same as the host",
  "hosts.editor.aJumpHost": "a jump host",
  "hosts.editor.monitoringOffForApp":
    "Monitoring is off for the app, so this host will be set up and not yet checked.",
  "hosts.editor.turnItOn": "Turn it on",
  "hosts.editor.disclosure.portForwarding": "Port forwarding",
  "hosts.editor.disclosure.remoteDesktop": "Remote desktop",
  "hosts.editor.disclosure.ipmi": "IPMI",
  "hosts.editor.disclosure.advanced": "Advanced",
  "hosts.editor.allowLegacy": "Allow legacy algorithms",
  "hosts.editor.allowLegacyDesc":
    "Enables SHA-1, CBC and 3DES for old servers. Weakens the connection, so leave off unless the handshake fails.",
  "hosts.editor.cancel": "Cancel",
  "hosts.editor.save": "Save host",
  "hosts.editor.create": "Create host",
  ...
  "keychain.editor.titleHello": "Windows Hello key",
  "keychain.editor.titleEdit": "Edit SSH key",
  "keychain.editor.titleGenerate": "Generate SSH key",
  "keychain.editor.titleImport": "Import SSH key",
  ...
  "keychain.editor.save": "Save key",
  "keychain.editor.name": "Key name",
  "keychain.editor.namePlaceholder": "e.g. My GitHub Key",
  "keychain.editor.helloHeld": "Held by Windows Hello",
  "keychain.editor.helloBody":
    "The private key lives in this PC’s TPM and cannot be exported, copied or backed up, not by this app and not by you. Every connection asks for Windows Hello.",
  "keychain.editor.helloWarn":
    "It only works from this machine. Reinstalling elsewhere, or resetting Windows Hello, loses it for good. Keep another key on your servers so that does not lock you out.",
  "keychain.editor.publicKey": "Public key",
  "keychain.editor.publicKeyOptional": "Public key (optional)",
  "keychain.editor.publicKeyHelloHint":
    "Put this line in ~/.ssh/authorized_keys on the servers you want to reach.",
  "keychain.editor.publicKeyImportHint":
    "Paste it to record the fingerprint and the algorithm.",
  "keychain.editor.publicKeyCopied": "Public key copied",
  "keychain.editor.copy": "Copy",
  "keychain.editor.fingerprint": "Fingerprint",
  "keychain.editor.keyType": "Key type",
  "keychain.editor.typeEd25519": "Modern, fast, secure (recommended)",
  "keychain.editor.typeEcdsa": "Elliptic Curve DSA",
  "keychain.editor.typeRsa": "Traditional RSA key",
  "keychain.editor.curveSize": "Elliptic curve size (bits)",
  "keychain.editor.keySize": "Key size (bits)",
  "keychain.editor.keySizeHint":
    "Optional. Left alone, ssh-keygen picks its own default.",
  "keychain.editor.comment": "Comment",
  "keychain.editor.commentHint": "Optional. Written into the key itself.",
  "keychain.editor.commentPlaceholder": "e.g. user@example.com",
  "keychain.editor.passphrase": "Passphrase",
  "keychain.editor.passphraseGenerateHint":
    "Optional. The generated key is encrypted with this.",
  "keychain.editor.passphraseGeneratePlaceholder":
    "Leave empty for no passphrase",
  "keychain.editor.generating": "Generating…",
  "keychain.editor.generate": "Generate key pair",
  "keychain.editor.importFromFile": "Import from a file",
  "keychain.editor.importFromFileHint":
    "Pick a key such as id_ed25519. A .pub or -cert.pub sitting beside it comes too, and the key is read without passing through this window.",
  "keychain.editor.choosing": "Choosing…",
  "keychain.editor.chooseFile": "Choose file",
  "keychain.editor.chooseAnother": "Choose another file",
  "keychain.editor.pasteInstead": "Paste instead",
  "keychain.editor.privateKey": "Private key",
  "keychain.editor.privateKeyFromFile": "Private key read from {file}",
  "keychain.editor.privateKeyGenerated": "Private key generated",
  "keychain.editor.privateKeyHeld":
    "It is held by the app and will be encrypted with the OS keystore when you save.",
  "keychain.editor.privateKeyStoredPlaceholder":
    "Stored, leave blank to keep the existing key",
  "keychain.editor.hidePrivate": "Hide private key",
  "keychain.editor.showPrivate": "Show private key",
  "keychain.editor.hidePassphrase": "Hide passphrase",
  "keychain.editor.showPassphrase": "Show passphrase",
  "keychain.editor.certificate": "Certificate (optional)",
  "keychain.editor.certHintEmpty":
    "Signed by a CA and presented instead of the bare key. Paste a *-cert.pub.",
  "keychain.editor.certNeverExpires": "never expires",
  "keychain.editor.certExpired": "EXPIRED {date}",
  "keychain.editor.certValidUntil": "valid until {date}",
  "keychain.editor.certLogsInAs": "logs in as {names}",
  "keychain.editor.certAnyUser": "valid for any username",
  "keychain.editor.certSummary": "{who} · {expiry} · CA {ca}",
  "keychain.editor.passphraseFileEncrypted":
    "{file} is encrypted. Without its passphrase the key cannot connect.",
  ...
  "proxies.editor.titleNew": "New proxy",
  "proxies.editor.titleEdit": "Edit proxy",
  "proxies.editor.subtitle":
    "A server to dial through. Hosts point at it, whatever they speak once they are connected.",
  "proxies.editor.check": "Check it answers",
  "proxies.editor.checking": "Checking…",
  "proxies.editor.create": "Create proxy",
  "proxies.editor.save": "Save proxy",
  "proxies.editor.speaks": "This proxy speaks",
  "proxies.editor.address": "Proxy address",
  "proxies.editor.port": "Port",
  "proxies.editor.name": "Name",
  "proxies.editor.nameHint":
    "Optional. Left blank, this proxy is listed as its address.",
  "proxies.editor.namePlaceholder": "e.g. Office bastion proxy",
  "proxies.editor.username": "Username",
  "proxies.editor.usernamePlaceholder": "Leave blank if it needs none",
  "proxies.editor.password": "Password",
  "proxies.editor.passwordStored": "Stored, leave blank to keep",
  "proxies.editor.passwordStoredHint": "A password is stored for this proxy.",
  "proxies.editor.showPassword": "Show password",
  "proxies.editor.hidePassword": "Hide password",
  "proxies.editor.ident": "Ident",
  "proxies.editor.identHint":
    "Sent in the clear as the SOCKS4 user id. Most proxies ignore it; leave it blank unless yours is checking it.",
  "proxies.editor.identPlaceholder": "Usually nothing",
  "proxies.editor.opening": "Opening a connection to the proxy…",
  "proxies.editor.optional": "Optional",
  "proxies.editor.reachedThrough": "Reached through",
  ...
  "proxies.editor.dialFromHere": "Dial it from this machine",
  "proxies.editor.advanced": "Advanced",
  "proxies.editor.remoteDns": "Let the proxy resolve hostnames",
  ...
  "proxies.editor.timeout": "Give up after",
  "proxies.editor.timeoutHint":
    "How long the proxy has to accept the connection and answer. The session itself is never cut off by this.",
  "proxies.editor.seconds": "seconds",
  ...
  "snippets.editor.titleNew": "New snippet",
  "snippets.editor.titleEdit": "Edit snippet",
  "snippets.editor.titleNewPackage": "New package",
  "snippets.editor.titleEditPackage": "Edit package",
  ...
  "snippets.editor.add": "Add snippet",
  "snippets.editor.addPackage": "Add package",
  "snippets.editor.kind": "Kind",
  "snippets.editor.kindCommand": "Command",
  "snippets.editor.kindPackage": "Package",
  ...
  "snippets.editor.name": "Name",
  "snippets.editor.namePlaceholder": "e.g. Tail nginx errors",
  "snippets.editor.namePlaceholderPackage": "e.g. Deploy and restart",
  "snippets.editor.command": "Command",
  "snippets.editor.commandHint":
    "Wrap anything you want to be asked for in double braces, e.g. {{service}}.",
  "snippets.editor.willAskFor": "Will ask for",
  "snippets.editor.description": "Description",
  "snippets.editor.descriptionHint": "Optional. Searched alongside the name.",
  "snippets.editor.descriptionPlaceholder":
    "What it does, or when to reach for it",
  "snippets.editor.tags": "Tags",
  "snippets.editor.tagsHint": "Comma separated.",
  "snippets.editor.availableOn": "Available on",
  "snippets.editor.allHosts": "All hosts",
  "snippets.editor.specificHosts": "Specific hosts",
  "snippets.editor.noHostWarning":
    "With no host selected this snippet will not appear anywhere.",
  "snippets.editor.runImmediately": "Run as soon as it is inserted",
  ...
  "folders.editor.titleNew": "New folder",
  "folders.editor.titleEdit": "Edit folder",
  "folders.editor.subtitle":
    "Folders group hosts. Deleting one keeps whatever was inside it.",
  "folders.editor.create": "Create folder",
  "folders.editor.save": "Save folder",
  "folders.editor.name": "Folder name",
  "folders.editor.namePlaceholder": "e.g. AWS Servers",

  /* ---------------------------------------------------------------- *
   * Logs
   * ---------------------------------------------------------------- */
  "logs.blurbStart":
    "Every connection made and every record changed on this machine, newest " +
    "first. Recorded against the signed-in OS account",
  "logs.blurbEnd":
    ", and tagged on the row only when it was somebody else. Passwords and key " +
  ...
  "monitor.unsupportedSerial":
    "A serial console has no network address to check.",
  "monitor.unsupportedJump":
    "This host is reached through a jump host, so there is no route to " +
   ...
   * ---------------------------------------------------------------- */
  "appColors.subtitle":
    "The six surfaces the app is built from. Pick the window colour and the " +
  ...
  "appColors.deriveHint":
    "Rewrites all six steps, keeping the app’s spacing between them",
  ...
  "termColors.subtitle":
    "Pick every color yourself, or start from a built-in theme and change " +
    "what you want.",
  ...
  "import.desc":
    "Read ~/.ssh/config and ~/.ssh/known_hosts and bring the hosts, their port " +
  ...
  "import.copyKeysDesc":
    "Each IdentityFile is read into the keychain and encrypted with the OS " +
  ...
  "appImport.desc":
    "Hosts, port forwards, folders and serial or desktop settings come across. " +
  ...
  "appImport.chooseFileHint":
    "A portable MobaXterm.ini, or a .mxtsessions export",
  ...
  "appImport.copyKeysDesc":
    "Each key file is read into the keychain and encrypted with the OS " +
    "keystore. Without this, imported hosts are set to use your SSH agent instead.",
  "appImport.chooseNextsshTitle": "Choose a NextSSH backup file",
  "appImport.copyNextsshKeysDesc":
    "Private keys in the backup are stored in the keychain and encrypted with the OS " +
  ...
  "settings.general.languageDesc":
    "The language the app’s own text is shown in. Terminal output " +
  ...
  "settings.general.restoreDesc":
    "Reopen the tabs that were open when the app closed and " +
  ...
  "settings.appearance.themeCustomDesc":
    "The app is using your own palette. Pick one to start " +
  ...
  "settings.appearance.appColorsDesc":
    "A palette to start from. Every surface in the app is " + "drawn from it.",
  ...
  "settings.appearance.customColorsDesc":
    "Set the window, panel, control and text colors yourself",
  ...
  "settings.appearance.showLogoDesc":
    "The mark in the title bar. Turning it off gives the tab " +
  ...
  "settings.terminal.desc":
    "How the shell looks inside a session, and what is kept of it.",
  "settings.terminal.font": "Font",
  "settings.terminal.fontAria": "Terminal font",
  "settings.terminal.fontDesc":
    "Only faces this machine actually has are listed. JetBrains Mono " +
    "ships with the app.",
  "settings.terminal.fontMissing":
    "This font is no longer installed on this machine, so the " +
  ...
  "settings.terminal.sizeDesc":
    "Applies to every open session. Each one refits and tells the " +
  ...
  "settings.terminal.weightDesc":
    "Bold keeps its contrast: it is drawn 300 heavier than whatever " +
    "is set here.",
  "settings.terminal.lineHeight": "Line height",
  "settings.terminal.lineHeightAria": "Line height",
  "settings.terminal.lineHeightDesc":
    "A multiple of the font size. Taller lines cost rows, which " +
  ...
  "settings.terminal.cursorDesc":
    "What the caret looks like where the shell is waiting.",
  ...
  "settings.terminal.smoothScrollDesc":
    "How long wheel and trackpad movements take to settle. " +
  ...
  "settings.terminal.linksDesc":
    "A URL printed in the session is clickable and opens in your " +
  ...
  "settings.terminal.resetDesc":
    "Resets the font, spacing, cursor, scrollback, scrolling and " +
  ...
  "settings.terminal.colorsDesc":
    "Choose a color scheme for your terminal, or build your own",
  ...
  "settings.monitoring.desc":
    "Check that hosts are still reachable while the app is open, and " +
  ...
  "settings.monitoring.masterDesc":
    "The master switch. Hosts are watched one at a time rather " +
  ...
  "settings.monitoring.intervalDesc":
    "Every watched host is checked on this interval. A check is " +
  ...
  "settings.monitoring.timeoutDesc":
    "A host that has not accepted the connection within this has " +
  ...
  "settings.monitoring.failuresDesc":
    "How many checks in a row have to fail. On wifi, leave this " +
  ...
  "settings.monitoring.notifyDesc":
    "A desktop notification, once, when a host crosses from " +
  ...
  "settings.monitoring.notifyBackDesc":
    "A second notification when a host that was down starts " +
  ...
  "settings.logging.desc":
    "Write what each session showed to a file, and decide which sessions " +
  ...
  "settings.logging.recordAllDesc":
    "Write what the server prints to a file, for every session as " +
  ...
  "settings.logging.whichSessionsDesc":
    "What kinds of session the switch above records. " +
  ...
  "settings.logging.formatDesc":
    "Readable strips the colour and cursor codes, which is what " +
  ...
  "settings.logging.timestampsUnavailable":
    "Not available for verbatim logs: a timestamp in the " +
  ...
  "settings.logging.retentionDesc":
    "Older transcripts are deleted, at launch and as sessions " +
  ...
  "settings.logging.capDesc":
    "Once the folder grows past this, the oldest transcripts are " +
  ...
  "settings.logging.folderDesc":
    "Logs hold whatever was on screen, which for a session that ran " +
  ...
  "settings.security.desc":
    "Who can open this app, and which servers it trusts.",

  "settings.lock.title": "Opening password",
  "settings.lock.badgeOn": "on",
  "settings.lock.descOn":
    "Asked for every time the app opens. Your saved passwords, keys and " +
    "passphrases are encrypted with it, so the stored file is unreadable without it.",
  "settings.lock.descOff":
    "Require a password to open the app, and encrypt your saved passwords, " +
    "keys and passphrases with it.",
  "settings.lock.warnOn":
    "There is no recovery. If you forget this password the saved " +
    "credentials cannot be read back.",
  "settings.lock.warnOff":
    "Without it, credentials are protected only by the OS keystore, which " +
  ...
  "settings.lock.acknowledgeDesc":
    "Your saved passwords, keys and passphrases are encrypted with " +
  ...
  "settings.lock.confirmMessage":
    "Every open session will be disconnected, and the password will " +
    "be needed to get back in.",
  "settings.lock.confirmAction": "Lock",

  "settings.knownHosts.title": "Known hosts",
  "settings.knownHosts.desc":
    "Server keys you have trusted. Forget one to be asked about it " +
  ...
  "settings.knownHosts.emptyNote":
    "The first time you connect to a server, its key will be " +
    "recorded here.",
  "settings.knownHosts.confirmTitle": "Forget this host key?",
  "settings.knownHosts.confirmMessage":
    "{host} will be treated as a new host the next time you " +
  ...
  "settings.account.webdavUrlHint":
    "Enter only the server address, e.g. https://dav.jianguoyun.com/dav/. NoxSSH/ is appended automatically as the backup path.",
  "settings.account.username": "Username",
  "settings.account.webdavPassword": "WebDAV Password",
  "settings.account.webdavPasswordHint":
    "HTTP Basic Auth password for your WebDAV server (stored securely).",
  "settings.account.syncPassphrase": "Sync Passphrase",
  "settings.account.syncPassphraseHint":
    "Used to encrypt your sync data before uploading. You will need this passphrase on any other device to restore.",
  "settings.account.saveUrlUser": "Save URL & Username",
  "settings.account.saveSecrets": "Save Passwords",
  "settings.account.test": "Test connection",
  "settings.account.testing": "Testing...",
  "settings.account.testOk": "Connection successful",
  "settings.account.enableSync": "Enable WebDAV sync",
  "settings.account.enableSyncDesc":
    "When on, local changes upload after about 8 seconds. The server is checked every 5 minutes, and again when you unlock or wake the computer. If the server copy is ahead, it is merged in before uploading.",
  "settings.account.saveNowHint":
    "Upload this computer’s current data now, without waiting for the automatic upload.",
  "settings.account.restoreNowHint":
    "Download the server copy now and replace the data on this computer, without waiting for the next automatic check.",
  "settings.account.syncOn": "WebDAV sync enabled",
  "settings.account.syncOff": "WebDAV sync disabled",
  "settings.account.configSaved": "Settings saved",
  "settings.account.secretsSaved": "Credentials updated",
  "settings.account.backedUp": "Uploaded to WebDAV",
  "settings.account.saveNow": "Upload now",
  "settings.account.saving": "Uploading…",
  "settings.account.savedAgo": "Uploaded {when}",
  "settings.account.notSavedYet": "Not uploaded yet",
  "settings.account.restoreNow": "Download now",
  "settings.account.restoring": "Downloading…",
  "settings.account.restored": "Downloaded from WebDAV",
  "settings.account.notRestoredYet": "Not downloaded yet",
  "settings.account.restoredAgo": "Downloaded {when}",
  ...
  "settings.account.backupSection": "Historical backups",
  "settings.account.backupEnabled": "Enable historical backups",
  ...
  "settings.account.backupFrequency": "Backup frequency",
  "settings.account.backupFrequencyManual": "Manual only",
  "settings.account.backupFrequencyHourly": "Hourly",
  "settings.account.backupFrequencyDaily": "Daily",
  "settings.account.backupFrequencyWeekly": "Weekly",
  "settings.account.maxBackups": "Keep at most",
  "settings.account.maxBackupsSuffix": "",
  "settings.account.backupNow": "Backup now",
  "settings.account.backingUp": "Backing up…",
  "settings.account.backupsTitle": "Available versions",
  "settings.account.noBackups": "No historical backups yet",
  "settings.account.restoreVersion": "Restore this version",
  "settings.account.restoringVersion": "Restoring…",
  "settings.account.backupCreated": "Backup created",
  "settings.account.backupRestored": "Restored from historical backup",
  "settings.account.lastBackup": "Last backup",
  "settings.account.backupOnNow": "Historical backups enabled",
  "settings.account.backupOffNow": "Historical backups disabled",
  "settings.account.revision": "Revision",
  ...
  "settings.backup.exportDesc":
    "Writes every host, folder, SSH key, snippet, port forward and " +
    "trusted host key to a single encrypted file, protected by a passphrase you choose here.",
  "settings.backup.exportNote":
    "The passphrase is independent of your opening password, so the " +
  ...
  "settings.backup.acknowledge":
    "I understand this file contains my saved credentials",
  "settings.backup.acknowledgeDesc":
    "Anyone who has both the file and this passphrase can read " +
  ...
  "settings.backup.restoreDesc":
    "Reads a .cbbackup file and adds what it holds. You are shown " +
    "what is in it before anything changes.",
  "settings.backup.restoreNote":
    "Anything already here is left alone by default, so restoring " +
    "twice is safe.",
  ...
  "settings.backup.overwriteDesc":
    "Matches on the record’s id, not its name. Leave this off to " +
  ...
  "settings.backup.restoredAndReplaced_one":
    "Restored {count} new item, replaced {replaced}",
  "settings.backup.restoredAndReplaced_other":
    "Restored {count} new items, replaced {replaced}",
  "settings.backup.duplicateKeys_one":
    "{count} host now trusts more than one key of the same " +
    "type. Check Security, then Known hosts.",
  "settings.backup.duplicateKeys_other":
    "{count} hosts now trust more than one key of the same " +
    "type. Check Security, then Known hosts.",
  ...
  "settings.about.ready":
    "Version {version} is ready to install. Restart to finish.",
  ...
  "settings.about.checksLeft_other":
    "{count} of {limit} checks left this hour.",
  ...
  "settings.about.noteNotify":
    "Updates are not installed automatically. The download opens in " +
  ...
  "hosts.deleteHostMessage":
    "“{name}” and its stored credentials will be removed. Any session " +
  ...
  "hosts.deleteFolderMessage":
    "“{name}” will be removed. Everything inside it moves up a level " +
  ...
  "hosts.deleteManyHostsNote":
    "Hosts are removed along with their stored credentials, and any " +
    "session already open stays connected.",
  "hosts.deleteManyFoldersNote":
    "Folders are removed, but everything inside them moves up a " +
  ...
  "hosts.tagSubtitle":
    "{what} selected. Part-ticked tags are on some of them, and stay that way " +
  ...
  "protocol.ssh.detail":
    "Files, port forwarding and a remote desktop are all channels on an SSH " +
  ...
  "protocol.telnet.detail":
    "Sends everything, passwords included, in the clear. For a console " +
  ...
  "protocol.serial.detail":
    "No network at all. The settings have to match the device exactly: a " +
  ...
  "protocol.desktop.detail":
    "Opens straight into the remote desktop and never dials SSH. For a " +
  ...
  "protocol.ipmi.detail":
    "Opens straight into the BMC’s own web interface and never dials the " +
  ...
  "serial.portMissing":
    "{path} is not connected right now. It is kept on the host, and will " +
  ...
  "serial.enterSendsHint":
    "No protocol answers this. A device given the wrong one looks dead: " +
  ...
  "serial.localEchoHint":
    "Turn on for a device that does not echo back. Without it the pane " +
    "stays blank while you type, which reads as a dead port rather than a quiet one.",
  "serial.dtr": "Assert DTR on open",
  "serial.dtrHint":
    "On by default, which is what most devices expect. Turn it off for a board " +
  ...
  "serial.noWindowSize":
    "A serial line carries no window size and no terminal type, so the " +
  ...
  "tunnel.bindAddressHint":
    'Needs "GatewayPorts yes" for anything but loopback',
  ...
  "tunnel.autoStartHint":
    "Brought up whenever this host connects, including after a reconnect.",
  ...
  "tunnel.sessionDown":
    "The session is not connected. Forwards will start again when it " +
    "reconnects.",
  ...
  "session.hostKeyChangedDesc":
    "The key this server presented is not the one you trusted for this " +
    "address.",
  ...
  "session.hostKeyUnknownDesc":
    "This server has not been seen before. Check its fingerprint against one you got " +
  ...
  "session.statusRetrying":
    "Reconnecting in {seconds}s (attempt {attempt} of {max})",
