...
export default {
  ...
  "hosts.editor.displayNameHint":
    "Left blank, this host is listed as {address}.",
  ...
  "settings.account.syncPassphraseHint":
    "Used to encrypt the snapshot before uploading. You will need this passphrase on any other device to restore.",
  ...
  "settings.account.enableSyncDesc":
    "Automatically push and pull your encrypted hosts, keys and settings.",
  ...
  "settings.account.backedUp": "Saved to WebDAV",
  ...
  "settings.account.restoreNow": "Restore now",
  "settings.account.restoring": "Restoring…",
  "settings.account.restored": "Restored from WebDAV",
  "settings.account.notRestoredYet": "Not restored yet",
  "settings.account.restoredAgo": "Restored {when}",
