...
export default {
    ...
    'hosts.editor.subtitle': 'Kết nối tới đâu, xác thực thế nào, và làm gì sau khi vào.',
    ...
    'hosts.editor.telnetWarning': 'Telnet không mã hoá. Mọi thứ gửi qua đó, kể cả những gì bạn gõ ở lời nhắc đăng nhập, đều có thể bị đọc trên đường đi. Chỉ dùng cho thiết bị không có lựa chọn tốt hơn.',
    'hosts.editor.hostname': 'Tên máy / IP',
    'hosts.editor.hostnameDesktopHint': 'Máy tính để bàn ở đâu. Được dùng trừ khi mục Máy tính để bàn bên dưới chỉ một địa chỉ khác.',
    'hosts.editor.hostnameIpmiHint': 'Bộ xử lý dịch vụ ở đâu. Được dùng trừ khi mục IPMI bên dưới chỉ một địa chỉ khác.',
    ...
    'hosts.editor.noKeysInKeychain': 'Chưa có khoá SSH. Hãy thêm trên trang Chuỗi khoá trước.',
    ...
    'hosts.editor.keyPassphrasePlaceholder': 'Để trống nếu khoá không có cụm mật khẩu',
    ...
    'hosts.editor.displayNameHint': 'Để trống thì máy chủ này được liệt kê là {address}.',
    'hosts.editor.displayNamePlaceholder': 'vd. Máy chủ sản xuất',
    'hosts.editor.tags': 'Thẻ',
    'hosts.editor.tagsHint': 'Thẻ xuyên thư mục: một máy chủ nằm trong một thư mục và có thể mang bao nhiêu thẻ cũng được.',
    'hosts.editor.disclosure.connectThrough': 'Kết nối qua',
    'hosts.editor.connectDirectly': 'Kết nối trực tiếp',
    'hosts.editor.jumpHintWith': 'Gọi máy này trước; máy đích sau đó đi qua một kênh trên nó. Phiên bên trong vẫn mã hoá đầu cuối, nên relay chỉ chuyển byte mà không đọc được.',
    'hosts.editor.jumpHintWithout': 'Với máy chủ mà máy này không có đường tới, hãy chỉ máy chủ nhảy có đường đó.',
    'hosts.editor.disclosure.proxies': 'Proxy',
    'hosts.editor.proxyHintWith': 'Socket được mở qua proxy, và proxy được yêu cầu tới địa chỉ ở trên. Mọi thứ phiên mang theo đều đi bên trong: tệp, chuyển tiếp cổng và máy tính để bàn gọi trực tiếp.',
    'hosts.editor.proxyHintWithout': 'Cho mạng chỉ tới được qua proxy SOCKS hoặc HTTP. Proxy đã lưu được quản lý trên trang Proxy.',
    'hosts.editor.noProxiesSaved': 'Chưa lưu proxy nào. Hãy thêm trên trang Proxy trước.',
    'hosts.editor.dialStraightOut': 'Gọi thẳng ra ngoài',
    'hosts.editor.proxyJumpNote': 'Đi qua {jump}; kết nối duy nhất ra khỏi máy này là tới {jump}, nên chính cài đặt proxy của nó mở đường. Proxy chọn ở đây dùng khi máy chủ này được gọi không qua relay.',
    'hosts.editor.disclosure.runOnConnect': 'Chạy khi kết nối',
    'hosts.editor.initHintSsh': 'Gửi vào shell ngay khi mở, và gửi lại sau khi kết nối lại. Mỗi dòng một lệnh.',
    'hosts.editor.initHintOther': 'Gửi ngay khi phiên mở, không chờ gì. Không có nhận diện lời nhắc, nên trên thiết bị hỏi đăng nhập thì nội dung này sẽ được gõ vào lời nhắc đăng nhập.',
    ...
    'hosts.editor.watchDesc': 'Khi ứng dụng đang mở, định kỳ kiểm tra xem chỗ này còn trả lời không. Máy chủ ngừng phản hồi sẽ báo một lần, và thẻ bị đánh dấu cho tới khi nó trở lại.',
    'hosts.editor.checkPort': 'Cổng kiểm tra',
    'hosts.editor.checkPortHint': 'Đặt để theo dõi thứ khác trên cùng máy, máy chủ web hoặc cơ sở dữ liệu, thay vì cổng đăng nhập của máy chủ này.',
    'hosts.editor.checkPortHintDefault': 'Để trống thì máy chủ này được kiểm trên cổng nó kết nối.',
    'hosts.editor.checkPortHintDefaultOn': 'Để trống thì máy chủ này được kiểm trên cổng {port}, cổng nó kết nối.',
    ...
    'hosts.editor.monitoringOffForApp': 'Giám sát đang tắt cho ứng dụng, nên máy chủ này sẽ được thiết lập nhưng chưa được kiểm.',
    ...
    'hosts.editor.allowLegacyDesc': 'Bật SHA-1, CBC và 3DES cho máy chủ cũ. Làm yếu kết nối, hãy để tắt trừ khi bắt tay thất bại.',
    ...
    'keychain.editor.subtitleHello': 'Khoá riêng nằm trong TPM của máy này. Không gì ở đây đọc được nó, kể cả ứng dụng này.',
    'keychain.editor.subtitle': 'Khoá nằm trong chuỗi khoá của ứng dụng và không rời tiến trình chính.',
    ...
    'keychain.editor.helloBody': 'Khoá riêng sống trong TPM của máy này và không thể xuất, sao chép hay sao lưu, ứng dụng này và bạn đều không làm được. Mỗi lần kết nối đều hỏi Windows Hello.',
    'keychain.editor.helloWarn': 'Chỉ dùng được từ máy này. Cài lại nơi khác hoặc đặt lại Windows Hello sẽ mất vĩnh viễn. Hãy giữ thêm một khoá khác trên máy chủ để không bị khoá ngoài.',
    'keychain.editor.publicKey': 'Khoá công khai',
    'keychain.editor.publicKeyOptional': 'Khoá công khai (tuỳ chọn)',
    'keychain.editor.publicKeyHelloHint': 'Đặt dòng này vào ~/.ssh/authorized_keys trên các máy chủ bạn muốn tới.',
    'keychain.editor.publicKeyImportHint': 'Dán vào để ghi lại vân tay và thuật toán.',
    ...
    'keychain.editor.keySizeHint': 'Tuỳ chọn. Không chọn thì ssh-keygen dùng mặc định của nó.',
    ...
    'keychain.editor.passphraseGenerateHint': 'Tuỳ chọn. Khoá tạo ra được mã hoá bằng cái này.',
    'keychain.editor.passphraseGeneratePlaceholder': 'Để trống nếu không dùng cụm mật khẩu',
    'keychain.editor.generating': 'Đang tạo…',
    'keychain.editor.generate': 'Tạo cặp khoá',
    'keychain.editor.importFromFile': 'Nhập từ tệp',
    'keychain.editor.importFromFileHint': 'Chọn một khoá như id_ed25519. Tệp .pub hoặc -cert.pub bên cạnh cũng được đọc, và khoá không đi qua cửa sổ này.',
    ...
    'keychain.editor.privateKeyHeld': 'Ứng dụng giữ nó và sẽ mã hoá bằng khoá hệ thống khi bạn lưu.',
    'keychain.editor.privateKeyStoredPlaceholder': 'Đã lưu, để trống để giữ nguyên',
    ...
    'keychain.editor.certHintEmpty': 'Do CA ký và được trình thay cho khoá trần. Hãy dán *-cert.pub.',
    ...
    'keychain.editor.passphraseFileEncrypted': '{file} đã được mã hoá. Không có cụm mật khẩu thì khoá không kết nối được.',
    'keychain.editor.passphraseStoredHint': 'Khoá này đã lưu cụm mật khẩu. Để trống để giữ nguyên.',
    'keychain.editor.passphraseImportHint': 'Chỉ khi khoá riêng ở trên đã được mã hoá.',
    'keychain.editor.passphraseStoredPlaceholder': 'Đã lưu, để trống để giữ nguyên',
    'keychain.editor.passphraseNonePlaceholder': 'Để trống nếu khoá không có',
    'keychain.editor.dangerZone': 'Vùng nguy hiểm',
    'keychain.editor.dangerZoneDesc': 'Xoá khoá này rồi thì không hoàn tác được. Hãy chắc chắn.',
    ...
    'proxies.editor.subtitle': 'Máy chủ để quay số xuyên qua. Máy chủ trỏ tới nó, bất kể chúng nói giao thức gì sau khi đã kết nối.',
    ...
    'proxies.editor.nameHint': 'Tuỳ chọn. Để trống thì proxy được liệt kê theo địa chỉ.',
    ...
    'proxies.editor.identHint': 'Gửi dạng rõ như id người dùng SOCKS4. Hầu hết proxy bỏ qua; hãy để trống trừ khi proxy của bạn kiểm tra nó.',
    ...
    'proxies.editor.viaHintWith': 'Gọi cái đó trước; proxy này sau đó đi qua nó. Mỗi cái chỉ biết cái tiếp theo, nên đầu kia thấy proxy cuối trên đường đi.',
    'proxies.editor.viaHintWithout': 'Với proxy mà máy này không tới trực tiếp được, hãy chỉ proxy nhìn thấy nó.',
    ...
    'proxies.editor.remoteDnsSocks4': 'Gửi tên chứ không phải địa chỉ, đó là điều SOCKS4a thêm vào. Chỉ tắt với proxy quá cũ không nhận tên.',
    'proxies.editor.remoteDnsDesc': 'Giữ DNS khỏi máy này, nên chỗ này không biết bạn tới máy nào, và mạng tách sẽ phân giải ở phía làm được. Tắt nếu proxy từ chối tên máy.',
    'proxies.editor.timeout': 'Bỏ cuộc sau',
    'proxies.editor.timeoutHint': 'Proxy có bao lâu để chấp nhận kết nối và trả lời. Bản thân phiên không bị cắt vì điều này.',
    ...
    'snippets.editor.subtitle': 'Một lệnh bạn giữ lại và gửi vào phiên từ bảng chọn.',
    'snippets.editor.subtitlePackage': 'Một chuỗi lệnh, gửi vào phiên theo thứ tự.',
    ...
    'snippets.editor.kindPackageHint': 'Các bước chạy theo thứ tự bạn đặt. Một bước có thể viết ở đây hoặc lấy từ thư viện.',
    ...
    'snippets.editor.commandHint': 'Bọc những gì bạn muốn được hỏi trong ngoặc kép, vd. {{service}}.',
    ...
    'snippets.editor.noHostWarning': 'Không chọn máy chủ thì đoạn lệnh này sẽ không xuất hiện ở đâu.',
    'snippets.editor.runImmediately': 'Chạy ngay khi chèn',
    'snippets.editor.runImmediatelyCommand': 'Nhấn Enter giúp bạn. Tắt để thả lệnh vào lời nhắc và đọc trước khi chạy.',
    'snippets.editor.runImmediatelyPackage': 'Nhấn Enter giúp bạn và bắt đầu cả chuỗi. Tắt để thả các bước vào lời nhắc rồi đọc trước khi chạy.',
    'folders.editor.titleNew': 'Thư mục mới',
    'folders.editor.titleEdit': 'Sửa thư mục',
    'folders.editor.subtitle': 'Thư mục nhóm các máy chủ. Xoá thư mục vẫn giữ những gì bên trong.',
    ...
    'settings.assistant.provider.relay': 'Dùng relay tương thích OpenAI. Không cần cài Claude Code, Codex hay OpenCode.',
    ...
    'settings.assistant.relayNote': 'Điền endpoint tương thích OpenAI, ví dụ https://example.com/v1. Không cần CLI cục bộ.',
    ...
    'settings.assistant.relayModelsEmpty': 'Relay không trả về danh sách mô hình. Bạn có thể nhập tên thủ công.',
    'settings.assistant.relayModelsFailed': 'Không tải được mô hình. Hãy kiểm tra địa chỉ và khoá.',
    'settings.assistant.accountRelay': 'Gọi mô hình qua relay. Điền địa chỉ và khoá API. Không cần tác nhân cục bộ.',
    ...
    'settings.monitoring.watchedButOff_one': 'Đã thiết lập {count} máy chủ, nhưng không có gì '
    ...
    'settings.monitoring.watchedButOff_other': 'Đã thiết lập {count} máy chủ, nhưng không có gì '
        + 'kiểm tra chúng khi công tắc ở trên đang tắt.',
    'settings.monitoring.watchedWithOffline_one': '{count} máy chủ, {offline} máy không phản hồi.',
    ...
    'settings.account.webdavUrlHint': 'Chỉ cần địa chỉ máy chủ. Đường dẫn noxssh/snapshot.json sẽ được thêm tự động.',
    'settings.account.username': 'Tên người dùng',
    'settings.account.webdavPassword': 'Mật khẩu WebDAV',
    'settings.account.webdavPasswordHint': 'Mật khẩu HTTP Basic của máy chủ WebDAV (được lưu an toàn).',
    'settings.account.syncPassphrase': 'Cụm mật khẩu đồng bộ',
    'settings.account.syncPassphraseHint': 'Mã hoá bản sao trước khi tải lên. Bạn sẽ cần nó trên thiết bị khác để khôi phục.',
    ...
    'settings.account.enableSyncDesc': 'Tự động đẩy và kéo máy chủ, khoá và cài đặt đã mã hoá.',
    ...
    'settings.account.webdavPrivacyNote': 'Dữ liệu được mã hoá trên thiết bị này bằng cụm mật khẩu đồng bộ trước khi rời máy. Mật khẩu WebDAV chỉ dùng để xác thực.',
    'settings.account.backupSection': 'Bản sao lịch sử',
    'settings.account.backupEnabled': 'Bật sao lưu lịch sử',
    'settings.account.backupEnabledDesc': 'Theo lịch tạo các tệp mã hoá có dấu thời gian trên máy chủ, tách khỏi bản sao trực tiếp.',
    ...
    'settings.backup.restoredAndReplaced_one': 'Đã khôi phục {count} mục mới, thay thế {replaced} mục',
    'settings.backup.restoredAndReplaced_other': 'Đã khôi phục {count} mục mới, thay thế {replaced} mục',
    'settings.backup.duplicateKeys_one': 'Hiện có {count} máy chủ tin cậy nhiều hơn một khoá cùng '
    ...
    'settings.about.checksLeft_one': 'Còn {count} trong {limit} lượt kiểm tra trong giờ này.',
