...
export default {
  ...
  /* ---- Hosts ---- */
  "hosts.count_one": "{count} máy chủ",
  "hosts.count_other": "{count} máy chủ",
  "hosts.folderCount_one": "{count} thư mục",
  ...
  "hosts.editor.titleNew": "Máy chủ mới",
  "hosts.editor.titleEdit": "Sửa máy chủ",
  "hosts.editor.subtitle":
    "Kết nối tới đâu, xác thực thế nào, và làm gì sau khi vào.",
  "hosts.editor.thisHostIs": "Máy chủ này là",
  "hosts.kind.ssh": "SSH",
  "hosts.kind.telnet": "Telnet",
  "hosts.kind.serial": "Cổng nối tiếp",
  "hosts.kind.desktop": "Máy tính để bàn",
  "hosts.kind.ipmi": "IPMI",
  "hosts.editor.telnetWarning":
    "Telnet không mã hoá. Mọi thứ gửi qua đó, kể cả những gì bạn gõ ở lời nhắc đăng nhập, đều có thể bị đọc trên đường đi. Chỉ dùng cho thiết bị không có lựa chọn tốt hơn.",
  ...
  "hosts.editor.username": "Tên người dùng",
  "hosts.editor.authMethod": "Phương thức xác thực",
  "hosts.editor.auth.password": "Mật khẩu",
  "hosts.editor.auth.passwordHint": "Gửi mật khẩu đã lưu",
  "hosts.editor.auth.keychain": "Chuỗi khoá",
  "hosts.editor.auth.keychainHint": "Dùng khoá trong chuỗi khoá của ứng dụng",
  "hosts.editor.auth.key": "Khoá",
  "hosts.editor.auth.keyHint": "Dán khoá riêng chỉ cho máy chủ này",
  "hosts.editor.auth.agent": "Agent",
  "hosts.editor.auth.agentHint": "Dùng các khoá do SSH agent giữ",
  "hosts.editor.sshKey": "Khoá SSH",
  "hosts.editor.noKeysInKeychain":
    "Chưa có khoá SSH. Hãy thêm trên trang Chuỗi khoá trước.",
  "hosts.editor.selectKey": "Chọn một khoá…",
  "hosts.editor.password": "Mật khẩu",
  "hosts.editor.passwordPlaceholderStored": "Đã lưu, để trống để giữ nguyên",
  "hosts.editor.passwordPlaceholder": "••••••••",
  "hosts.editor.showPassword": "Hiện mật khẩu",
  "hosts.editor.hidePassword": "Ẩn mật khẩu",
  "hosts.editor.storedPasswordHint": "Máy chủ này đã lưu một mật khẩu.",
  "hosts.editor.privateKey": "Khoá riêng",
  "hosts.editor.privateKeyPlaceholderStored": "Đã lưu, để trống để giữ nguyên",
  "hosts.editor.privateKeyPlaceholder": "-----BEGIN OPENSSH PRIVATE KEY-----…",
  "hosts.editor.storedPrivateKeyHint": "Máy chủ này đã lưu một khoá riêng.",
  "hosts.editor.keyPassphrase": "Cụm mật khẩu khoá",
  "hosts.editor.keyPassphrasePlaceholder":
    "Để trống nếu khoá không có cụm mật khẩu",
  "hosts.editor.chooseKeyFile": "Chọn tệp khoá…",
  "hosts.editor.optional": "Tuỳ chọn",
  ...
  "hosts.editor.tagsHint":
    "Thẻ xuyên thư mục: một máy chủ nằm trong một thư mục và có thể mang bao nhiêu thẻ cũng được.",
  "hosts.editor.disclosure.connectThrough": "Kết nối qua",
  "hosts.editor.connectDirectly": "Kết nối trực tiếp",
  "hosts.editor.jumpHintWith":
    "Gọi máy này trước; máy đích sau đó đi qua một kênh trên nó. Phiên bên trong vẫn mã hoá đầu cuối, nên relay chỉ chuyển byte mà không đọc được.",
  "hosts.editor.jumpHintWithout":
    "Với máy chủ mà máy này không có đường tới, hãy chỉ máy chủ nhảy có đường đó.",
  "hosts.editor.disclosure.proxies": "Proxy",
  "hosts.editor.proxyHintWith":
    "Socket được mở qua proxy, và proxy được yêu cầu tới địa chỉ ở trên. Mọi thứ phiên mang theo đều đi bên trong: tệp, chuyển tiếp cổng và máy tính để bàn gọi trực tiếp.",
  "hosts.editor.proxyHintWithout":
    "Cho mạng chỉ tới được qua proxy SOCKS hoặc HTTP. Proxy đã lưu được quản lý trên trang Proxy.",
  "hosts.editor.noProxiesSaved":
    "Chưa lưu proxy nào. Hãy thêm trên trang Proxy trước.",
  "hosts.editor.dialStraightOut": "Gọi thẳng ra ngoài",
  "hosts.editor.proxyJumpNote":
    "Đi qua {jump}; kết nối duy nhất ra khỏi máy này là tới {jump}, nên chính cài đặt proxy của nó mở đường. Proxy chọn ở đây dùng khi máy chủ này được gọi không qua relay.",
  "hosts.editor.disclosure.runOnConnect": "Chạy khi kết nối",
  "hosts.editor.initHintSsh":
    "Gửi vào shell ngay khi mở, và gửi lại sau khi kết nối lại. Mỗi dòng một lệnh.",
  "hosts.editor.initHintOther":
    "Gửi ngay khi phiên mở, không chờ gì. Không có nhận diện lời nhắc, nên trên thiết bị hỏi đăng nhập thì nội dung này sẽ được gõ vào lời nhắc đăng nhập.",
  "hosts.editor.initPlaceholderSsh": "cd /srv/app && tmux attach",
  "hosts.editor.initPlaceholderOther": "terminal length 0",
  "hosts.editor.disclosure.monitoring": "Giám sát",
  "hosts.editor.watchThisHost": "Theo dõi máy chủ này",
  "hosts.editor.watchDesc":
    "Khi ứng dụng đang mở, định kỳ kiểm tra xem chỗ này còn trả lời không. Máy chủ ngừng phản hồi sẽ báo một lần, và thẻ bị đánh dấu cho tới khi nó trở lại.",
  "hosts.editor.checkPort": "Cổng kiểm tra",
  "hosts.editor.checkPortHint":
    "Đặt để theo dõi thứ khác trên cùng máy, máy chủ web hoặc cơ sở dữ liệu, thay vì cổng đăng nhập của máy chủ này.",
  "hosts.editor.checkPortHintDefault":
    "Để trống thì máy chủ này được kiểm trên cổng nó kết nối.",
  "hosts.editor.checkPortHintDefaultOn":
    "Để trống thì máy chủ này được kiểm trên cổng {port}, cổng nó kết nối.",
  "hosts.editor.monitorSummary": "Đang theo dõi",
  "hosts.editor.monitorSummaryWithPort": "Theo dõi trên cổng {port}",
  "hosts.editor.advancedSummary": "Cho phép thuật toán cũ",
  "hosts.editor.desktopRdp": "RDP",
  "hosts.editor.desktopVnc": "VNC",
  "hosts.editor.bmcSameHost": "Giống máy chủ",
  "hosts.editor.aJumpHost": "một máy chủ nhảy",
  "hosts.editor.monitoringOffForApp":
    "Giám sát đang tắt cho ứng dụng, nên máy chủ này sẽ được thiết lập nhưng chưa được kiểm.",
  "hosts.editor.turnItOn": "Bật lên",
  "hosts.editor.disclosure.portForwarding": "Chuyển tiếp cổng",
  "hosts.editor.disclosure.remoteDesktop": "Máy tính từ xa",
  "hosts.editor.disclosure.ipmi": "IPMI",
  "hosts.editor.disclosure.advanced": "Nâng cao",
  "hosts.editor.allowLegacy": "Cho phép thuật toán cũ",
  "hosts.editor.allowLegacyDesc":
    "Bật SHA-1, CBC và 3DES cho máy chủ cũ. Làm yếu kết nối, hãy để tắt trừ khi bắt tay thất bại.",
  "hosts.editor.cancel": "Huỷ",
  "hosts.editor.save": "Lưu máy chủ",
  "hosts.editor.create": "Tạo máy chủ",

  /* ---- Keychain ---- */
  "keychain.count_one": "{count} khoá",
  ...
  "keychain.editor.titleHello": "Khoá Windows Hello",
  "keychain.editor.titleEdit": "Sửa khoá SSH",
  "keychain.editor.titleGenerate": "Tạo khoá SSH",
  "keychain.editor.titleImport": "Nhập khoá SSH",
  "keychain.editor.subtitleHello":
    "Khoá riêng nằm trong TPM của máy này. Không gì ở đây đọc được nó, kể cả ứng dụng này.",
  "keychain.editor.subtitle":
    "Khoá nằm trong chuỗi khoá của ứng dụng và không rời tiến trình chính.",
  "keychain.editor.save": "Lưu khoá",
  "keychain.editor.name": "Tên khoá",
  "keychain.editor.namePlaceholder": "vd. Khoá GitHub của tôi",
  "keychain.editor.helloHeld": "Do Windows Hello giữ",
  "keychain.editor.helloBody":
    "Khoá riêng sống trong TPM của máy này và không thể xuất, sao chép hay sao lưu, ứng dụng này và bạn đều không làm được. Mỗi lần kết nối đều hỏi Windows Hello.",
  "keychain.editor.helloWarn":
    "Chỉ dùng được từ máy này. Cài lại nơi khác hoặc đặt lại Windows Hello sẽ mất vĩnh viễn. Hãy giữ thêm một khoá khác trên máy chủ để không bị khoá ngoài.",
  "keychain.editor.publicKey": "Khoá công khai",
  "keychain.editor.publicKeyOptional": "Khoá công khai (tuỳ chọn)",
  "keychain.editor.publicKeyHelloHint":
    "Đặt dòng này vào ~/.ssh/authorized_keys trên các máy chủ bạn muốn tới.",
  "keychain.editor.publicKeyImportHint":
    "Dán vào để ghi lại vân tay và thuật toán.",
  "keychain.editor.publicKeyCopied": "Đã sao chép khoá công khai",
  "keychain.editor.copy": "Sao chép",
  "keychain.editor.fingerprint": "Vân tay",
  "keychain.editor.keyType": "Loại khoá",
  "keychain.editor.typeEd25519": "Hiện đại, nhanh, an toàn (khuyến nghị)",
  "keychain.editor.typeEcdsa": "DSA đường cong elliptic",
  "keychain.editor.typeRsa": "Khoá RSA truyền thống",
  "keychain.editor.curveSize": "Kích thước đường cong elliptic (bit)",
  "keychain.editor.keySize": "Kích thước khoá (bit)",
  "keychain.editor.keySizeHint":
    "Tuỳ chọn. Không chọn thì ssh-keygen dùng mặc định của nó.",
  "keychain.editor.comment": "Ghi chú",
  "keychain.editor.commentHint": "Tuỳ chọn. Được ghi vào chính khoá.",
  "keychain.editor.commentPlaceholder": "vd. user@example.com",
  "keychain.editor.passphrase": "Cụm mật khẩu",
  "keychain.editor.passphraseGenerateHint":
    "Tuỳ chọn. Khoá tạo ra được mã hoá bằng cái này.",
  "keychain.editor.passphraseGeneratePlaceholder":
    "Để trống nếu không dùng cụm mật khẩu",
  "keychain.editor.generating": "Đang tạo…",
  "keychain.editor.generate": "Tạo cặp khoá",
  "keychain.editor.importFromFile": "Nhập từ tệp",
  "keychain.editor.importFromFileHint":
    "Chọn một khoá như id_ed25519. Tệp .pub hoặc -cert.pub bên cạnh cũng được đọc, và khoá không đi qua cửa sổ này.",
  "keychain.editor.choosing": "Đang chọn…",
  "keychain.editor.chooseFile": "Chọn tệp",
  "keychain.editor.chooseAnother": "Chọn tệp khác",
  "keychain.editor.pasteInstead": "Dán thay thế",
  "keychain.editor.privateKey": "Khoá riêng",
  "keychain.editor.privateKeyFromFile": "Đã đọc khoá riêng từ {file}",
  "keychain.editor.privateKeyGenerated": "Đã tạo khoá riêng",
  "keychain.editor.privateKeyHeld":
    "Ứng dụng giữ nó và sẽ mã hoá bằng khoá hệ thống khi bạn lưu.",
  "keychain.editor.privateKeyStoredPlaceholder":
    "Đã lưu, để trống để giữ nguyên",
  "keychain.editor.hidePrivate": "Ẩn khoá riêng",
  "keychain.editor.showPrivate": "Hiện khoá riêng",
  "keychain.editor.hidePassphrase": "Ẩn cụm mật khẩu",
  "keychain.editor.showPassphrase": "Hiện cụm mật khẩu",
  "keychain.editor.certificate": "Chứng chỉ (tuỳ chọn)",
  "keychain.editor.certHintEmpty":
    "Do CA ký và được trình thay cho khoá trần. Hãy dán *-cert.pub.",
  "keychain.editor.certNeverExpires": "không hết hạn",
  "keychain.editor.certExpired": "ĐÃ HẾT HẠN {date}",
  "keychain.editor.certValidUntil": "có hiệu lực đến {date}",
  "keychain.editor.certLogsInAs": "đăng nhập với tư cách {names}",
  "keychain.editor.certAnyUser": "hợp lệ với mọi tên người dùng",
  "keychain.editor.certSummary": "{who} · {expiry} · CA {ca}",
  "keychain.editor.passphraseFileEncrypted":
    "{file} đã được mã hoá. Không có cụm mật khẩu thì khoá không kết nối được.",
  "keychain.editor.passphraseStoredHint":
    "Khoá này đã lưu cụm mật khẩu. Để trống để giữ nguyên.",
  "keychain.editor.passphraseImportHint":
    "Chỉ khi khoá riêng ở trên đã được mã hoá.",
  "keychain.editor.passphraseStoredPlaceholder":
    "Đã lưu, để trống để giữ nguyên",
  "keychain.editor.passphraseNonePlaceholder": "Để trống nếu khoá không có",
  "keychain.editor.dangerZone": "Vùng nguy hiểm",
  "keychain.editor.dangerZoneDesc":
    "Xoá khoá này rồi thì không hoàn tác được. Hãy chắc chắn.",
  "keychain.editor.delete": "Xoá khoá này",

  /* ---- Proxies ---- */
  "proxies.empty": "Chưa có proxy nào",
  "proxies.emptyNote":
    "Thêm một proxy SOCKS hoặc HTTP và mọi máy chủ đều có thể kết nối qua nó: " +
    "phiên terminal, SFTP, chuyển tiếp cổng và cả máy tính từ xa.",
  "proxies.newProxy": "Proxy mới",
  "proxies.search": "Tìm proxy",
  "proxies.editor.titleNew": "Proxy mới",
  "proxies.editor.titleEdit": "Sửa proxy",
  "proxies.editor.subtitle":
    "Máy chủ để quay số xuyên qua. Máy chủ trỏ tới nó, bất kể chúng nói giao thức gì sau khi đã kết nối.",
  "proxies.editor.check": "Kiểm tra xem có trả lời không",
  "proxies.editor.checking": "Đang kiểm tra…",
  "proxies.editor.create": "Tạo proxy",
  "proxies.editor.save": "Lưu proxy",
  "proxies.editor.speaks": "Proxy này dùng",
  "proxies.editor.address": "Địa chỉ proxy",
  "proxies.editor.port": "Cổng",
  "proxies.editor.name": "Tên",
  "proxies.editor.nameHint":
    "Tuỳ chọn. Để trống thì proxy được liệt kê theo địa chỉ.",
  "proxies.editor.namePlaceholder": "vd. Proxy nhảy văn phòng",
  "proxies.editor.username": "Tên người dùng",
  "proxies.editor.usernamePlaceholder": "Để trống nếu không cần",
  "proxies.editor.password": "Mật khẩu",
  "proxies.editor.passwordStored": "Đã lưu, để trống để giữ nguyên",
  "proxies.editor.passwordStoredHint": "Proxy này đã lưu một mật khẩu.",
  "proxies.editor.showPassword": "Hiện mật khẩu",
  "proxies.editor.hidePassword": "Ẩn mật khẩu",
  "proxies.editor.ident": "Ident",
  "proxies.editor.identHint":
    "Gửi dạng rõ như id người dùng SOCKS4. Hầu hết proxy bỏ qua; hãy để trống trừ khi proxy của bạn kiểm tra nó.",
  "proxies.editor.identPlaceholder": "Thường để trống",
  "proxies.editor.opening": "Đang mở kết nối tới proxy…",
  "proxies.editor.optional": "Tuỳ chọn",
  "proxies.editor.reachedThrough": "Đi tới qua",
  "proxies.editor.viaHintWith":
    "Gọi cái đó trước; proxy này sau đó đi qua nó. Mỗi cái chỉ biết cái tiếp theo, nên đầu kia thấy proxy cuối trên đường đi.",
  "proxies.editor.viaHintWithout":
    "Với proxy mà máy này không tới trực tiếp được, hãy chỉ proxy nhìn thấy nó.",
  "proxies.editor.dialFromHere": "Gọi từ máy này",
  "proxies.editor.advanced": "Nâng cao",
  "proxies.editor.remoteDns": "Để proxy phân giải tên máy",
  "proxies.editor.remoteDnsSocks4":
    "Gửi tên chứ không phải địa chỉ, đó là điều SOCKS4a thêm vào. Chỉ tắt với proxy quá cũ không nhận tên.",
  "proxies.editor.remoteDnsDesc":
    "Giữ DNS khỏi máy này, nên chỗ này không biết bạn tới máy nào, và mạng tách sẽ phân giải ở phía làm được. Tắt nếu proxy từ chối tên máy.",
  "proxies.editor.timeout": "Bỏ cuộc sau",
  "proxies.editor.timeoutHint":
    "Proxy có bao lâu để chấp nhận kết nối và trả lời. Bản thân phiên không bị cắt vì điều này.",
  "proxies.editor.seconds": "giây",

  /* ---- Snippets ---- */
  "snippets.count_one": "{count} đoạn lệnh",
  "snippets.count_other": "{count} đoạn lệnh",
  "snippets.empty": "Chưa có đoạn lệnh nào",
  "snippets.emptyNote":
    "Lưu lại những lệnh bạn phải gõ đi gõ lại trên mọi máy.",
  ...
  "snippets.editor.titleNew": "Đoạn lệnh mới",
  "snippets.editor.titleEdit": "Sửa đoạn lệnh",
  "snippets.editor.titleNewPackage": "Gói mới",
  "snippets.editor.titleEditPackage": "Sửa gói",
  "snippets.editor.subtitle":
    "Một lệnh bạn giữ lại và gửi vào phiên từ bảng chọn.",
  "snippets.editor.subtitlePackage":
    "Một chuỗi lệnh, gửi vào phiên theo thứ tự.",
  "snippets.editor.add": "Thêm đoạn lệnh",
  "snippets.editor.addPackage": "Thêm gói",
  "snippets.editor.kind": "Loại",
  "snippets.editor.kindCommand": "Lệnh",
  "snippets.editor.kindPackage": "Gói",
  "snippets.editor.kindCommandHint": "Một đoạn văn bản, thả vào lời nhắc.",
  "snippets.editor.kindPackageHint":
    "Các bước chạy theo thứ tự bạn đặt. Một bước có thể viết ở đây hoặc lấy từ thư viện.",
  "snippets.editor.name": "Tên",
  "snippets.editor.namePlaceholder": "vd. Theo dõi lỗi nginx",
  "snippets.editor.namePlaceholderPackage": "vd. Triển khai và khởi động lại",
  "snippets.editor.command": "Lệnh",
  "snippets.editor.commandHint":
    "Bọc những gì bạn muốn được hỏi trong ngoặc kép, vd. {{service}}.",
  "snippets.editor.willAskFor": "Sẽ hỏi",
  "snippets.editor.description": "Mô tả",
  "snippets.editor.descriptionHint": "Tuỳ chọn. Được tìm cùng với tên.",
  "snippets.editor.descriptionPlaceholder": "Nó làm gì, hoặc khi nào dùng",
  "snippets.editor.tags": "Thẻ",
  "snippets.editor.tagsHint": "Phân tách bằng dấu phẩy.",
  "snippets.editor.availableOn": "Có trên",
  "snippets.editor.allHosts": "Mọi máy chủ",
  "snippets.editor.specificHosts": "Máy chủ cụ thể",
  "snippets.editor.noHostWarning":
    "Không chọn máy chủ thì đoạn lệnh này sẽ không xuất hiện ở đâu.",
  "snippets.editor.runImmediately": "Chạy ngay khi chèn",
  "snippets.editor.runImmediatelyCommand":
    "Nhấn Enter giúp bạn. Tắt để thả lệnh vào lời nhắc và đọc trước khi chạy.",
  "snippets.editor.runImmediatelyPackage":
    "Nhấn Enter giúp bạn và bắt đầu cả chuỗi. Tắt để thả các bước vào lời nhắc rồi đọc trước khi chạy.",
  "folders.editor.titleNew": "Thư mục mới",
  "folders.editor.titleEdit": "Sửa thư mục",
  "folders.editor.subtitle":
    "Thư mục nhóm các máy chủ. Xoá thư mục vẫn giữ những gì bên trong.",
  "folders.editor.create": "Tạo thư mục",
  "folders.editor.save": "Lưu thư mục",
  "folders.editor.name": "Tên thư mục",
  "folders.editor.namePlaceholder": "vd. Máy chủ AWS",

  /* ---- Logs ---- */
  "logs.blurbStart":
    "Mọi kết nối đã tạo và mọi bản ghi đã thay đổi trên máy này, mới nhất " +
    "trước. Được ghi kèm tài khoản hệ điều hành đang đăng nhập",
  "logs.blurbEnd":
    ", và chỉ đánh dấu trên dòng khi đó là người khác. Mật khẩu và nội dung khoá " +
  ...
  "logs.emptyNote":
    "Kết nối và thay đổi sẽ xuất hiện ở đây khi bạn thực hiện chúng.",
  ...
  "newTab.subtitle":
    "Chọn một máy chủ, hoặc gõ địa chỉ để kết nối thẳng tới nó.",
  ...
  "newTab.notSavedNote":
    "Chưa lưu. Thông tin đăng nhập sẽ được hỏi khi kết nối.",
  ...
  "titleBar.closeGroupTabs_one": "Đóng cả {count} thẻ",
  ...
  "monitor.unsupportedSerial":
    "Cổng serial không có địa chỉ mạng nào để kiểm tra.",
  "monitor.unsupportedJump":
    "Máy chủ này được truy cập qua một máy trung gian, nên từ máy này " +
  ...
  "monitor.describeOnlineLatency":
    "đã phản hồi trong {latency} ms, kiểm tra {when}",
  "monitor.describeUnknown": "chưa kiểm tra",

  /* ---- App palette editor ---- */
  "appColors.subtitle":
    "Sáu bề mặt tạo nên toàn bộ ứng dụng. Chọn màu cửa sổ rồi phần còn lại " +
    "sẽ theo sau, hoặc tự đặt từng bậc.",
  "appColors.surfaces": "Bề mặt",
  "appColors.derive": "Dựng từ một màu",
  "appColors.deriveHint":
    "Viết lại cả sáu bậc, vẫn giữ khoảng cách vốn có giữa chúng",
  ...
  "termColors.subtitle":
    "Tự chọn từng màu, hoặc bắt đầu từ một chủ đề có sẵn rồi sửa những gì " +
    "bạn muốn.",
  ...
  "import.desc":
    "Đọc ~/.ssh/config và ~/.ssh/known_hosts rồi đưa các máy chủ, các cổng chuyển " +
    "tiếp và các khoá đã tin cậy của chúng vào đây.",
  "import.nothingFound":
    "Không tìm thấy gì trong {dir}. Bạn vẫn có thể tự chọn một tệp.",
  ...
  "import.copyKeys":
    "Sao chép cả các khoá riêng tư mà những máy chủ này tham chiếu",
  "import.copyKeysDesc":
    "Mỗi IdentityFile được đọc vào kho khoá và mã hoá bằng kho khoá của hệ " +
  ...
  "import.hostKeyCount_one": "{count} khoá máy chủ",
  "import.hostKeyCount_other": "{count} khoá máy chủ",
  "import.report":
    "Đã nhập {hosts} máy chủ, {keys} khoá, {hostKeys} khoá máy chủ.",
  ...
  "appImport.desc":
    "Máy chủ, cổng chuyển tiếp, thư mục và các thiết lập serial hoặc máy tính từ " +
  ...
  "appImport.sessionCount_one": "{count} phiên đã lưu",
  ...
  "appImport.chooseFileHint":
    "Một tệp MobaXterm.ini bản portable, hoặc một bản xuất .mxtsessions",
  ...
  "appImport.copyKeysDesc":
    "Mỗi tệp khoá được đọc vào kho khoá và mã hoá bằng kho khoá của hệ " +
    "điều hành. Không bật thì các máy chủ nhập vào sẽ dùng SSH agent của bạn.",
  "appImport.chooseNextsshTitle": "Chọn tệp sao lưu NextSSH",
  "appImport.copyNextsshKeysDesc":
    "Khoá riêng trong bản sao lưu được lưu vào kho khoá và mã hoá bằng kho khoá hệ " +
  ...
  "settings.general.languageDesc":
    "Ngôn ngữ hiển thị cho phần chữ của chính ứng dụng. Kết quả " +
  ...
  "settings.general.restoreDesc":
    "Mở lại các thẻ đang mở lúc đóng ứng dụng và kết nối lại tới " +
  ...
  "settings.appearance.themeCustomDesc":
    "Ứng dụng đang dùng bảng màu riêng của bạn. Chọn một " +
  ...
  "settings.appearance.appColorsDesc":
    "Một bảng màu để bắt đầu. Mọi bề mặt trong ứng dụng đều " +
    "được dựng từ nó.",
  ...
  "settings.appearance.customColorsDesc":
    "Tự đặt màu cho cửa sổ, bảng, điều khiển và chữ",
  ...
  "settings.appearance.showLogoDesc":
    "Biểu tượng trên thanh tiêu đề. Tắt đi thì chỗ đó dành cho " + "dải thẻ.",
  ...
  "settings.terminal.desc":
    "Shell trông thế nào bên trong một phiên, và những gì được giữ lại.",
  "settings.terminal.font": "Phông chữ",
  "settings.terminal.fontAria": "Phông chữ terminal",
  "settings.terminal.fontDesc":
    "Chỉ liệt kê những phông máy này thực sự có. JetBrains Mono đi " +
    "kèm với ứng dụng.",
  "settings.terminal.fontMissing":
    "Phông này không còn được cài trên máy, nên terminal đã quay " +
    "về JetBrains Mono.",
  ...
  "settings.terminal.sizeDesc":
    "Áp dụng cho mọi phiên đang mở. Mỗi phiên sẽ dàn lại và báo kích " +
  ...
  "settings.terminal.weightDesc":
    "Chữ đậm vẫn giữ được độ tương phản: nó luôn nặng hơn giá trị " +
  ...
  "settings.terminal.lineHeightDesc":
    "Tính theo bội số của cỡ chữ. Dòng cao hơn thì số dòng ít " +
  ...
  "settings.terminal.scrollbackDesc":
    "Số dòng giữ lại phía trên đỉnh cửa sổ, cho mỗi phiên. Tìm " +
  ...
  "settings.terminal.smoothScrollDesc":
    "Thời gian để chuyển động cuộn bằng con lăn chuột hoặc " +
  ...
  "settings.terminal.linksDesc":
    "Một URL in ra trong phiên có thể bấm được và sẽ mở trong trình " +
  ...
  "settings.terminal.resetAlready":
    "Mọi mục ở trên đều đang ở giá trị mặc định.",
  "settings.terminal.resetDesc":
    "Đặt lại phông, khoảng cách, con trỏ, bộ đệm cuộn, độ mượt khi " +
  ...
  "settings.terminal.colorsDesc":
    "Chọn một bảng màu cho terminal, hoặc tự dựng riêng",
  ...
  "settings.assistant.agentDesc":
    ...
    "này, một relay, hoặc một mô hình do chính bạn chạy. Đổi tác nhân sẽ bắt đầu một cuộc trò chuyện mới.",
  ...
  "settings.assistant.provider.relayName": "Trạm trung chuyển",
  "settings.assistant.provider.relay":
    "Dùng relay tương thích OpenAI. Không cần cài Claude Code, Codex hay OpenCode.",
  ...
  "settings.assistant.relayBaseUrl": "Địa chỉ relay",
  ...
  "settings.assistant.relayModelsEmpty":
    "Relay không trả về danh sách mô hình. Bạn có thể nhập tên thủ công.",
  "settings.assistant.relayModelsFailed":
    "Không tải được mô hình. Hãy kiểm tra địa chỉ và khoá.",
  "settings.assistant.accountRelay":
    "Gọi mô hình qua relay. Điền địa chỉ và khoá API. Không cần tác nhân cục bộ.",
  ...
  "settings.monitoring.desc":
    "Kiểm tra xem các máy chủ còn liên lạc được không trong lúc ứng " +
  ...
  "settings.monitoring.masterDesc":
    "Công tắc chính. Máy chủ được theo dõi từng máy một chứ không " +
  ...
  "settings.monitoring.intervalDesc":
    "Mỗi máy chủ được theo dõi sẽ được kiểm tra theo khoảng " +
  ...
  "settings.monitoring.timeoutDesc":
    "Máy chủ không chấp nhận kết nối trong khoảng này coi như " +
  ...
  "settings.monitoring.failuresDesc":
    "Cần bao nhiêu lần kiểm tra trượt liên tiếp. Khi dùng wifi, " +
  ...
  "settings.monitoring.notifyDesc":
    "Một thông báo trên màn hình, đúng một lần, khi máy chủ " +
  ...
  "settings.monitoring.notifyBackDesc":
    "Một thông báo thứ hai khi máy chủ vốn đang mất kết nối " +
  ...
  "settings.monitoring.noneWatched":
    "Việc theo dõi được bật cho từng máy chủ, trong trình sửa " + "máy chủ.",
  "settings.monitoring.watched_one": "{count} máy chủ.",
  "settings.monitoring.watched_other": "{count} máy chủ.",
  "settings.monitoring.watchedButOff_one":
    "Đã thiết lập {count} máy chủ, nhưng không có gì " +
  ...
  "settings.monitoring.watchedWithOffline_one":
    "{count} máy chủ, {offline} máy không phản hồi.",
  ...
  "settings.monitoring.emptyListHow":
    "Mở một máy chủ từ trang Máy chủ, tìm mục Theo dõi trong " +
    "phần Tuỳ chọn, rồi bật “Theo dõi máy chủ này”.",
  "settings.monitoring.noNetwork":
    "Máy này không có kết nối mạng, nên không có gì được kiểm tra " +
    "và cũng không có máy chủ nào bị báo là mất kết nối.",
  "settings.monitoring.allFailed":
    "Mọi máy chủ đều trượt lần kiểm tra vừa rồi cùng một lúc, và " +
  ...
  "settings.logging.desc":
    "Ghi những gì mỗi phiên hiển thị ra một tệp, và quyết định phiên nào " +
  ...
  "settings.logging.recordAllDesc":
    "Ghi những gì máy chủ in ra vào một tệp, cho mọi phiên ngay " +
  ...
  "settings.logging.whichSessionsDesc":
    "Công tắc ở trên ghi những loại phiên nào. Việc ghi một " +
  ...
  "settings.logging.formatDesc":
    "“Dễ đọc” loại bỏ các mã màu và mã con trỏ, đó là thứ khiến một " +
  ...
  "settings.security.desc":
    "Ai được mở ứng dụng này, và nó tin cậy những máy chủ nào.",

  "settings.lock.title": "Mật khẩu mở ứng dụng",
  "settings.lock.badgeOn": "bật",
  "settings.lock.descOn":
    "Được hỏi mỗi lần ứng dụng mở ra. Mật khẩu, khoá và cụm mật khẩu bạn đã " +
    "lưu đều được mã hoá bằng nó, nên tệp lưu trữ không đọc được nếu thiếu nó.",
  "settings.lock.descOff":
    "Yêu cầu mật khẩu để mở ứng dụng, và dùng nó mã hoá các mật khẩu, khoá " +
    "và cụm mật khẩu bạn đã lưu.",
  "settings.lock.warnOn":
    "Không có cách nào khôi phục. Nếu bạn quên mật khẩu này thì các thông " +
    "tin đăng nhập đã lưu không đọc lại được nữa.",
  "settings.lock.warnOff":
    "Không có nó, thông tin đăng nhập chỉ được kho khoá của hệ điều hành " +
  ...
  "settings.lock.acknowledgeDesc":
    "Mật khẩu, khoá và cụm mật khẩu bạn đã lưu đều được mã hoá " +
  ...
  "settings.lock.confirmMessage":
    "Mọi phiên đang mở sẽ bị ngắt kết nối, và bạn sẽ cần mật khẩu " +
    "để vào lại.",
  "settings.lock.confirmAction": "Khoá",

  "settings.knownHosts.title": "Máy chủ đã biết",
  "settings.knownHosts.desc":
    "Các khoá máy chủ bạn đã tin cậy. Quên một khoá để được hỏi lại về " +
  ...
  "settings.knownHosts.keyCount_one": "{count} khoá",
  ...
  "settings.knownHosts.emptyNote":
    "Lần đầu bạn kết nối tới một máy chủ, khoá của nó sẽ được ghi " +
    "lại ở đây.",
  "settings.knownHosts.confirmTitle": "Quên khoá máy chủ này?",
  "settings.knownHosts.confirmMessage":
    "Lần kết nối tới, {host} sẽ được coi là một máy chủ mới, " +
  ...
  "settings.account.webdavPasswordHint":
    "Mật khẩu HTTP Basic của máy chủ WebDAV (được lưu an toàn).",
  "settings.account.syncPassphrase": "Cụm mật khẩu đồng bộ",
  "settings.account.syncPassphraseHint":
    "Mã hoá bản sao trước khi tải lên. Bạn sẽ cần nó trên thiết bị khác để khôi phục.",
  "settings.account.saveUrlUser": "Lưu địa chỉ và tên",
  "settings.account.saveSecrets": "Lưu mật khẩu",
  "settings.account.test": "Kiểm tra kết nối",
  "settings.account.testing": "Đang kiểm tra…",
  ...
  "settings.account.backupFrequencyDaily": "Hàng ngày",
  "settings.account.backupFrequencyWeekly": "Hàng tuần",
  "settings.account.maxBackups": "Giữ tối đa",
  "settings.account.maxBackupsSuffix": "",
  "settings.account.backupNow": "Sao lưu ngay",
  "settings.account.backingUp": "Đang sao lưu…",
  "settings.account.backupsTitle": "Phiên bản có sẵn",
  "settings.account.noBackups": "Chưa có bản sao lịch sử",
  "settings.account.restoreVersion": "Khôi phục phiên bản này",
  ...
  "settings.backup.exportDesc":
    "Ghi mọi máy chủ, thư mục, khoá SSH, đoạn lệnh, cổng chuyển tiếp " +
    "và khoá máy chủ đã tin cậy vào một tệp mã hoá duy nhất, được bảo vệ bằng cụm mật khẩu " +
    "bạn chọn ở đây.",
  "settings.backup.exportNote":
    "Cụm mật khẩu này độc lập với mật khẩu mở ứng dụng, nên tệp vẫn " +
  ...
  "settings.backup.acknowledge":
    "Tôi hiểu tệp này chứa các thông tin đăng nhập đã lưu của tôi",
  "settings.backup.acknowledgeDesc":
    "Bất kỳ ai có cả tệp lẫn cụm mật khẩu này đều đọc được mọi " +
  ...
  "settings.backup.restoreDesc":
    "Đọc một tệp .cbbackup và thêm những gì nó chứa. Bạn được xem " +
    "trong đó có gì trước khi bất cứ thứ gì thay đổi.",
  "settings.backup.restoreNote":
    "Mặc định, những gì đã có ở đây được để nguyên, nên khôi phục " +
    "hai lần vẫn an toàn.",
  ...
  "settings.backup.hostWord_one": "máy chủ",
  ...
  "settings.backup.overwriteDesc":
    "Đối chiếu theo id của bản ghi chứ không theo tên. Để tắt thì " +
  ...
  "settings.backup.overwriteWarning":
    "Các thay đổi cục bộ trên những bản ghi tương ứng sẽ mất.",
  ...
  "settings.about.ready":
    "Phiên bản {version} đã sẵn sàng để cài. Khởi động lại để hoàn tất.",
  ...
  "settings.about.noChecksUntil":
    "Đã hết lượt kiểm tra trong giờ này, cho tới {when}.",
  "settings.about.checksLeft_one":
    "Còn {count} trong {limit} lượt kiểm tra trong giờ này.",
  "settings.about.checksLeft_other":
    "Còn {count} trong {limit} lượt kiểm tra trong giờ này.",
  "settings.about.noteInstall":
    "Bản cập nhật được tải ngầm và cài khi bạn thoát ứng dụng. Việc " +
    "kiểm tra chỉ hỏi GitHub về bản phát hành mới nhất và không gửi bất cứ thông tin nào về " +
    "bạn hay máy của bạn.",
  "settings.about.noteNotify":
    "Bản cập nhật không được cài tự động. Phần tải về sẽ mở trong " +
  ...
  "hosts.deleteHostMessage":
    "“{name}” và các thông tin đăng nhập đã lưu của nó sẽ bị xoá. Phiên " +
  ...
  "hosts.deleteFolderMessage":
    "“{name}” sẽ bị xoá. Mọi thứ bên trong sẽ chuyển lên một cấp chứ " +
    "không bị xoá theo.",
  ...
  "hosts.deleteManyHostsNote":
    "Các máy chủ bị xoá cùng với thông tin đăng nhập đã lưu, và phiên " +
    "nào đang mở thì vẫn giữ kết nối.",
  "hosts.deleteManyFoldersNote":
    "Các thư mục bị xoá, nhưng mọi thứ bên trong chuyển lên một cấp " +
    "chứ không bị xoá theo.",
  "hosts.deleteFailed": "Không xoá được: {reason}",

  "hosts.moved": "Đã chuyển {what}",
  "hosts.movedSome":
    "Đã chuyển {count} trong {of}; phần còn lại không vào được đó",
  ...
  "hosts.folderSubtitle":
    "Thư mục dùng để nhóm các máy chủ. Xoá thư mục vẫn giữ lại những gì " +
    "nằm trong đó.",
  ...
  "hosts.tagSubtitle":
    "Đã chọn {what}. Các thẻ đánh dấu một phần chỉ có trên một số máy, và giữ " +
  ...
  "protocol.ssh.detail":
    "Tệp, chuyển tiếp cổng và máy tính từ xa đều là các kênh trên một kết " +
  ...
  "protocol.telnet.detail":
    "Gửi mọi thứ, kể cả mật khẩu, ở dạng rõ. Dành cho máy chủ console, " +
    "một PDU hoặc một switch chưa từng có SSH.",
  "protocol.serial.summary": "Một cáp console trên máy này",
  "protocol.serial.detail":
    "Hoàn toàn không qua mạng. Các thiết lập phải khớp chính xác với " +
  ...
  "protocol.desktop.detail":
    "Mở thẳng vào màn hình từ xa và không bao giờ gọi SSH. Dành cho máy " +
  ...
  "protocol.ipmi.detail":
    "Mở thẳng vào giao diện web của chính BMC và không bao giờ gọi tới máy. " +
  ...
  "serial.noPorts":
    "Không tìm thấy cổng serial nào. Cắm bộ chuyển đổi vào rồi quét lại.",
  "serial.portMissing":
    "{path} hiện không được kết nối. Nó vẫn được giữ trên máy chủ và sẽ hoạt " +
  ...
  "serial.enterSendsHint":
    "Không giao thức nào trả lời được câu này. Thiết bị nhận sai giá trị " +
  ...
  "serial.localEchoHint":
    "Bật cho thiết bị không tự hiện lại. Không có nó thì khung vẫn trống " +
    "khi bạn gõ, và điều đó trông như một cổng chết chứ không phải một cổng im lặng.",
  "serial.dtr": "Bật DTR khi mở",
  "serial.dtrHint":
    "Mặc định bật, đúng như phần lớn thiết bị mong đợi. Hãy tắt với bo mạch được " +
    "nối để reset theo DTR, nếu không nó sẽ khởi động lại mỗi lần cổng này được mở.",
  "serial.rts": "Bật RTS khi mở",
  "serial.rtsHint":
    "Mặc định bật. Một số bộ chuyển đổi nối RTS vào chân reset hoặc boot.",
  "serial.rtsIgnored":
    "Bị bỏ qua khi điều khiển luồng phần cứng đang bật: khi đó RTS thuộc về " +
    "trình điều khiển.",
  "serial.noWindowSize":
    "Đường serial không mang kích thước cửa sổ hay loại terminal, nên thiết " +
    "bị luôn coi là 80×24 dù khung có lớn đến đâu.",

  /* ---- Port forwarding ---- */
  "tunnel.heading": "Chuyển tiếp cổng",
  "tunnel.headingNote":
    "Đường hầm chạy trên kết nối của phiên này và dừng khi phiên đóng.",
  "tunnel.local": "Cục bộ",
  "tunnel.remote": "Từ xa",
  "tunnel.dynamic": "Động",
  "tunnel.local.summary": "Tiếp cận một dịch vụ ở xa từ máy này",
  "tunnel.local.detail":
    "Mở một cổng ở đây. Mọi thứ kết nối tới nó sẽ đi ra ở máy chủ, rồi máy " +
    "chủ gọi tới đích.",
  "tunnel.remote.summary": "Đưa một dịch vụ cục bộ ra máy chủ",
  "tunnel.remote.detail":
    "Mở một cổng trên máy chủ. Các kết nối nó nhận sẽ được gọi từ máy này.",
  "tunnel.dynamic.summary": "Một proxy SOCKS5 qua máy chủ",
  "tunnel.dynamic.detail":
    "Mở một proxy SOCKS5 ở đây. Mỗi kết nối tự nêu đích của mình, và máy " +
    "chủ sẽ gọi tới đó.",
  ...
  "tunnel.destHostRemoteHint":
    "Được phân giải từ máy chủ, nên các tên nội bộ của nó vẫn dùng được",
  "tunnel.destPort": "Cổng đích",
  "tunnel.autoStart": "Khởi động cùng kết nối",
  "tunnel.autoStartHint":
    "Được bật lên mỗi khi máy chủ này kết nối, kể cả sau khi kết nối lại.",
  "tunnel.autoBadge": "tự động",
  "tunnel.exposedWarning":
    "Bất kỳ ai tiếp cận được máy này trên mạng đều sẽ dùng được chuyển " +
  ...
  "tunnel.sessionDown":
    "Phiên chưa kết nối. Các chuyển tiếp sẽ chạy lại khi phiên kết nối lại.",
  "tunnel.empty": "Chưa có chuyển tiếp cổng nào",
  "tunnel.emptyNote":
    "Chuyển tiếp một cổng để tiếp cận cơ sở dữ liệu hay một bảng điều khiển " +
  ...
  "session.hostKeyChangedDesc":
    "Khóa mà máy chủ này vừa đưa ra không khớp với khóa bạn đã tin tưởng cho địa chỉ " +
    "này.",
  "session.hostKeyChangedWarn":
    "Máy chủ vừa cài lại hoặc vừa đổi khóa trông đúng như thế này. Kẻ đứng giữa cũng " +
  ...
  "session.hostKeyUnknownDesc":
    "Máy chủ này chưa từng được thấy. Hãy đối chiếu dấu vân tay với một bản bạn lấy " +
  ...
  "session.statusRetrying":
    "Kết nối lại sau {seconds}s (lần {attempt} / {max})",
